...
namespace Lusid.Instruments.Examples.Instruments
{
    ...
    public class BondExamples: DemoInstrumentBase
    {
        ...
        public void BondCreationAndUpsertionExample()
        {
            ...
            var getResponse = _instrumentsApi.GetInstruments("ClientInternal", new List<string> { uniqueId }, asAt: upsertResponse.Values.First().Value.VarVersion.AsAtDate);
        ...
        public void ZeroCouponBondCreationAndUpsertionExample()
        {
            ...
            // CAN NOW QUERY FROM LUSID
            var getResponse = _instrumentsApi.GetInstruments("ClientInternal", new List<string> { uniqueId }, upsertResponse.Values.First().Value.VarVersion.AsAtDate);
            ValidateInstrumentResponse(getResponse, uniqueId);
